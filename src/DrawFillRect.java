...
public class DrawFillRect extends DrawObject {
	...
	public void paint(Graphics g) {
		for(int i = 0; i< mouseStartLineList.size(); i++) {
			...
			g.setColor(color);
			g.fillRect(pointStart.x, pointStart.y, pointEnd.x - pointStart.x, pointEnd.y - pointStart.y);
			g.fillRect(pointStart.x, pointEnd.y, pointEnd.x - pointStart.x, pointStart.y - pointEnd.y);
			g.fillRect(pointEnd.x, pointStart.y, pointStart.x - pointEnd.x, pointEnd.y - pointStart.y);
			g.fillRect(pointEnd.x, pointEnd.y, pointStart.x - pointEnd.x, pointStart.y - pointEnd.y);
		}
	}
	...
	public void mouseDragged(MouseEvent e) {
		...
		g.fillRect(startPoint.x, oldEndPoint.y, oldEndPoint.x - startPoint.x, startPoint.y - oldEndPoint.y);
		g.fillRect(oldEndPoint.x, startPoint.y, startPoint.x - oldEndPoint.x, oldEndPoint.y - startPoint.y);
		g.fillRect(oldEndPoint.x, oldEndPoint.y, startPoint.x - oldEndPoint.x, startPoint.y - oldEndPoint.y);
		...
		g.fillRect(endPoint.x, startPoint.y, startPoint.x - endPoint.x, endPoint.y - startPoint.y);
		g.fillRect(endPoint.x, endPoint.y, startPoint.x - endPoint.x, startPoint.y - endPoint.y);
