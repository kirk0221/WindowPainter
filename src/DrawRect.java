...
public class DrawRect extends DrawObject {
	...
	public void paint(Graphics g) {
		for(int i = 0; i< mouseStartLineList.size(); i++) {
			...
			g.drawRect(pointStart.x, pointEnd.y, pointEnd.x - pointStart.x, pointStart.y - pointEnd.y);
			g.drawRect(pointEnd.x, pointStart.y, pointStart.x - pointEnd.x, pointEnd.y - pointStart.y);
			g.drawRect(pointEnd.x, pointEnd.y, pointStart.x - pointEnd.x, pointStart.y - pointEnd.y);
		}
	}
	...
	public void mouseDragged(MouseEvent e) {
		...
		g.drawRect(startPoint.x, oldEndPoint.y, oldEndPoint.x - startPoint.x, startPoint.y - oldEndPoint.y);
		g.drawRect(oldEndPoint.x, startPoint.y, startPoint.x - oldEndPoint.x, oldEndPoint.y - startPoint.y);
		g.drawRect(oldEndPoint.x, oldEndPoint.y, startPoint.x - oldEndPoint.x, startPoint.y - oldEndPoint.y);
		g.drawRect(startPoint.x, startPoint.y, endPoint.x - startPoint.x, endPoint.y - startPoint.y);
		g.drawRect(startPoint.x, endPoint.y, endPoint.x - startPoint.x, startPoint.y - endPoint.y);
		g.drawRect(endPoint.x, startPoint.y, startPoint.x - endPoint.x, endPoint.y - startPoint.y);
		g.drawRect(endPoint.x, endPoint.y, startPoint.x - endPoint.x, startPoint.y - endPoint.y);
